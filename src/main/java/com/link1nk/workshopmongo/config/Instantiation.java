package com.link1nk.workshopmongo.config;
...
import com.link1nk.workshopmongo.dto.AuthorDTO;
import com.link1nk.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("21/03/2018"), "Bom dia", "Cheguei em São Paulo", new AuthorDTO(maria));
